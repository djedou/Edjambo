...
function (_Component) {
  ...
  function AnnoncesBody(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AnnoncesBody).call(this, props));
    console.log(_this.props);
    return _this;
  }
...
function (_Component) {
  ...
  function AssociationsBody(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AssociationsBody).call(this, props));
    console.log(_this.props);
    return _this;
  }
  ...
  _createClass(BodyContainer, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("section", {
        ...
        styleId: "2236714251",
        css: ".bodyright.jsx-2236714251{background-color:white;text-align:center;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/home/user/mesProjets/Edjambo/client/src/components/admin/body/BodyContainer.js */",
        __self: this
      }));
    }
  }]);
...
function (_Component) {
  ...
  function EnbcBody(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(EnbcBody).call(this, props));
    console.log(_this.props);
    return _this;
  }
...
function (_Component) {
  ...
  function GallerieBody(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GallerieBody).call(this, props));
    console.log(_this.props);
    return _this;
  }
...
function (_Component) {
  ...
  function MediaBody(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaBody).call(this, props));
    console.log(_this.props);
    return _this;
  }
...
function (_Component) {
  ...
  function MembresBody(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MembresBody).call(this, props));
    console.log(_this.props);
    return _this;
  }
...
//# sourceMappingURL=admin.js.5e1e5c92c05a82c4ed63.hot-update.js.map