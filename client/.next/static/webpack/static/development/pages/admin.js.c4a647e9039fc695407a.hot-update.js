...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! prop-types */ "./node_modules/next/node_modules/prop-types/index.js");
...
function findRange(native, editor) {
  ...
  var window = get_window__WEBPACK_IMPORTED_MODULE_0___default()(el);
...
debug('ANDROID_API_VERSION', { ANDROID_API_VERSION: slate_dev_environment__WEBPACK_IMPORTED_MODULE_3__["ANDROID_API_VERSION"] });
...
function cloneFragment(event, editor) {
  ...
  var valFromSelection = slate__WEBPACK_IMPORTED_MODULE_2__["Value"].create({ document: fragment });
  var plainText = slate_plain_serializer__WEBPACK_IMPORTED_MODULE_7__["default"].serialize(valFromSelection);
...
function getEventTransfer(event) {
  ...
  if (node) node = slate_base64_serializer__WEBPACK_IMPORTED_MODULE_6__["default"].deserializeNode(node);
...
function AfterPlugin() {
  ...
  function onPaste(event, editor, next) {
    ...
    if (type === 'text' || type === 'html') {
      ...
      var frag = slate_plain_serializer__WEBPACK_IMPORTED_MODULE_7__["default"].deserialize(text, { defaultBlock: defaultBlock, defaultMarks: defaultMarks }).document;
...
function BeforePlugin() {
  ...
  function onBlur(event, editor, next) {
    ...
    if (relatedTarget) {
      var el = react_dom__WEBPACK_IMPORTED_MODULE_9___default.a.findDOMNode(editor);
  ...
  createClass(Text, [{
    ...
    value: function render() {
      ...
      var decs = decorations.filter(function (d) {
        ...
        if (slate__WEBPACK_IMPORTED_MODULE_2__["PathUtils"].compare(path, start.path) === -1) return false;

        // If the node's path is after the end path, ignore it.
        if (slate__WEBPACK_IMPORTED_MODULE_2__["PathUtils"].compare(path, end.path) === 1) return false;
...
var Void = function (_React$Component) {
  ...
  createClass(Void, [{
    ...
    value: function render() {
      ...
      var spacer = react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(
        Tag,
        { 'data-slate-spacer': true, style: style },
        this.renderText()
      );

      var content = react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(
        Tag,
...
var Node$1 = function (_React$Component) {
  ...
  createClass(Node$$1, [{
    ...
    value: function render() {
      ...
      return editor.query('isVoid', node) ? react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(
        Void,
        this.props,
        element
      ) : element;
...
var Editor$1 = function (_React$Component) {
  ...
  function Editor$$1() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Editor$$1.__proto__ || Object.getPrototypeOf(Editor$$1)).call.apply(_ref, [this].concat(args))), _this), _this.state = { value: _this.props.defaultValue
      ...
      _this.controller = new slate__WEBPACK_IMPORTED_MODULE_2__["Editor"]({ plugins: [react], onChange: onChange }, { controller: _this, construct: false });
  ...
  _createClass(ActNouBody, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        styleId: "3406636741",
        css: "div.jsx-3406636741{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:left;-webkit-justify-content:left;-ms-flex-pack:left;justify-content:left;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;}span.jsx-3406636741{text-align:left;}.nouveau1.jsx-3406636741{border:2px solid blue;text-align:left;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/home/user/mesProjets/Edjambo/client/src/components/admin/body/ActNouBody.js */",
        __self: this
      }));
    }
  }]);
...
//# sourceMappingURL=admin.js.c4a647e9039fc695407a.hot-update.js.map